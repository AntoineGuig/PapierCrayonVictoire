<?php
$sql = "SELECT *,DATE_FORMAT(Concours.dateDebut, '%d/%m/%Y') as debut,DATE_FORMAT(Concours.dateFin, '%d/%m/%Y') as fin FROM Concours WHERE statut = 'terminé';";
$stmt = $pdo->prepare($sql);
$stmt->execute();
$concours = $stmt->fetchall(PDO::FETCH_ASSOC);

echo '<h1 class="align_center mrg-top15-bottom10">Vous trouverez l\'historique des concours</h1>';
