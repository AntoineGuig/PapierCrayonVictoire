    ...
    <nav>
        <div class="navbar">
            ...
            <span class="deconnexion">
                <?php echo "<p>Bonjour " . $_SESSION['prenom'] . " ! </p>  <form method=\"post\"> <input  id=\"btnDeco\"  type=\"submit\" name=\"deconnexion\" value=\"deconnexion\"/> </form> "
                ?>
            </span>
            <div class="admin">
                <?php
                ...
                try {
                    ...
                    if (isset($_SESSION['login']) && $nbAdmin['nbAdmin'] == 1) {
                        echo "<form method=\"post\"> <input id=\"btnAdmin\" type=\"submit\" name=\"admin\" value=\"admin\"/> </form>";
                    }
